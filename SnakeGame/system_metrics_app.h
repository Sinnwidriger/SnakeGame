#ifndef SNAKE_GAME_APPLICATIONS_SYSTEM_METRICS_APP_H_
#define SNAKE_GAME_APPLICATIONS_SYSTEM_METRICS_APP_H_
...
class SystemMetricsApp
{
 public:
	...
	SystemMetricsApp(const SystemMetricsApp&) = delete;
	SystemMetricsApp& operator=(const SystemMetricsApp&) = delete;
	SystemMetricsApp(SystemMetricsApp&&) = default;
	SystemMetricsApp& operator=(SystemMetricsApp&&) = default;

	// Public Methods
	static std::unique_ptr<SystemMetricsApp> Create();
	bool Initialize();
	int Run();
